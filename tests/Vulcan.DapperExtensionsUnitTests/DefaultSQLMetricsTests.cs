        ...
        public async Task TestMetrics(int executeMS,bool loggerIt)
        {
            ...
            loggerMock.Verify(
                x => x.Log(
                    LogLevel.Warning,
                    It.IsAny<EventId>(),
                    It.Is<It.IsAnyType>((o, t) => o.ToString().StartsWith("SQL EXECUTE Finished")),//string.Equals("Index page say hello", o.ToString(), StringComparison.InvariantCultureIgnoreCase)
                    It.IsAny<Exception>(),
                    It.IsAny<Func<It.IsAnyType, Exception, string>>()),
