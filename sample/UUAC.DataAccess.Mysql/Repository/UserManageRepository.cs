...
,view_root_code as ViewRootCode,view_root_name as ViewRootName,sequence as Sequence,`status` as `Status`,last_modify_time as LastModifyTime,last_modify_user_id as LastModifyUserId
...
,last_modify_user_name as LastModifyUserName,user_num as UserNum , gender as Gender FROM user_info WHERE user_uid = @UserUId";
        ...
        private static UserInfo Map(IUserInfo source)
        {
            UserInfo user = new UserInfo
            {
                ...
                ViewRootCode = source.ViewRootCode,
                ViewRootName = source.ViewRootName,
